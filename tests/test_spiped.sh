...
check_leftover_nc_server() {
	...
	# (suspected) hanging, can leave a nc_server_binary server floating around,
	...
	# Find old nc_server_binary server on ${dst_port}.
...
# up a nc_server_binary server listening to ${dst_port}, saving output to
